...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($result) {
       ...
       // exit();
        ...
        header("Location: EditUser.php?message=error");
        exit();
    }
} else {
				...
				<div class="col-md-10 col-md-offset-1">
					<div class="panel panel-default">
                        ...
                        <div class="form-group">
                                        ...
                                        <img class="item-img img-fluid" width="60%" src="../profilePic/<?php echo $row['profile_pic']; ?>" alt="<?php echo $row['profile_pic']; ?>">
									...
									<div class="form-group">
										...
										<input type="email" class="form-control" id="email" 
											readonly  value="<?php echo $row['email']?>" name="email">
									</div>

                                    <div class="form-group">
										<label for="phone">Phone Number</label>
										<input type="tel" class="form-control" id="phone" readonly  value="<?php echo $row['phone_number']?>">
									</div>
							...
							<div class="col-md-6">
                                    ...
                                    <div class="form-group">
										...
										<input type="text" class="form-control" id="doctype" name="doctype"  value="<?php echo $row['doctype']?>">
									</div>
                                    <div class="form-group">
										...
										<input type="hidden" class="form-control" id="old_document" name="old_document"  value="<?php echo $row['document']?>">
									</div>
